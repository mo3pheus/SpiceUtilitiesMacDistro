...
*****************************************************************************************************/
#define SEPARATOR "====================================================================================\n"
#define LEAP_SECONDS_KERNEL "/Users/skorgao/Documents/workspace/SpiceUtilitiesMacDistro/src/main/resources/mslsp_1000/data/lsk/naif0012.tls"
#define SCLK_KERNEL "/Users/skorgao/Documents/workspace/SpiceUtilitiesMacDistro/src/main/resources/mslsp_1000/data/sclk/msl_lmst_ops120808_v1.tsc"
#define STR_LEN 50
...
int main(int argc, char** argv)
	{
		/* Declare variables */
		SpiceChar ephemerisTime[STR_LEN];		/* user entered ephemerisTime	   */
